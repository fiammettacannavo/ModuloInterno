...
/* harmony import */ var utils_Data__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! utils/Data */ "./utils/Data.ts");
/* harmony import */ var utils_Predicted__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! utils/Predicted */ "./utils/Predicted.ts");
...
function () {
  ...
  StrategyRL.prototype.predict = function (data, predictor) {
    ...
    var base = 1 - (opt.toPredict || 0); //the other one
    ...
    var predicted = new utils_Predicted__WEBPACK_IMPORTED_MODULE_1__["Predicted"]();

    if (!data) {
      throw Error('Data not found');
    }

    var it = new utils_Data__WEBPACK_IMPORTED_MODULE_0__["DataIterator"](data);
    var val;
